...
-- -----------------------------------------------------
-- Table `db_loja_games`.`tb _usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb _usuarios` (
  `id` BIGINT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_produtos` (
  ...
  INDEX `fk_tb_produtos_tb _usuarios1_idx` (`usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_produtos_tb_categorias`
    FOREIGN KEY (`categorias_id`)
    REFERENCES `db_loja_games`.`tb_categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_produtos_tb _usuarios1`
    FOREIGN KEY (`usuarios_id`)
    REFERENCES `db_loja_games`.`tb _usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
